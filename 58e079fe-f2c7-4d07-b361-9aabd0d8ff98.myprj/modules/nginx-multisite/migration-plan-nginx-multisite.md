...
**TLDR**: This cookbook configures Nginx as a web server with multiple virtual hosts (3 sites), all with SSL enabled. It includes security hardening through fail2ban, UFW firewall, SSH hardening, and sysctl security settings.
...
2. **security** (`cookbooks/nginx-multisite/recipes/security.rb`):
   ...
   - Configures sysctl security settings
