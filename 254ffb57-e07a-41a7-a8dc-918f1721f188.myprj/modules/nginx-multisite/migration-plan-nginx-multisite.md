...
3. **nginx** (`cookbooks/nginx-multisite/recipes/nginx.rb`):
   ...
   - Creates directories for: test.cluster.local, ci.cluster.local, status.cluster.local
...
4. **ssl** (`cookbooks/nginx-multisite/recipes/ssl.rb`):
   ...
   - Generates certificates for: test.cluster.local, ci.cluster.local, status.cluster.local
...
5. **sites** (`cookbooks/nginx-multisite/recipes/sites.rb`):
   ...
   - Creates configs for: test.cluster.local, ci.cluster.local, status.cluster.local
...
# Security checks
ls -la /etc/ssl/private/test.cluster.local.key  # Should be readable only by root and ssl-cert group
