...
ls -la /etc/ssl/private/test.cluster.local.key  # Should be 640 permissions
ls -la /etc/ssl/private/ci.cluster.local.key  # Should be 640 permissions
ls -la /etc/ssl/private/status.cluster.local.key  # Should be 640 permissions
